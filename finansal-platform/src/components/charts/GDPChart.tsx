...
import { getEconomicData, getGDPData } from '@/services/economicDataService';
...
export function GDPChart({ title = 'GSYİH Büyüme Oranı', height = '400px' }: GDPChartProps) {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        console.error('GSYİH verileri yüklenirken hata:', err);
