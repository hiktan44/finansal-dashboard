        ...
        return `
          <div style="padding: 8px">
            ...
            <div style="display: flex; align-items: center; gap: 8px; margin-bottom: 4px">
              ...
              <span>${(data.us_original || 0).toLocaleString()} ${data.us_unit}</span>
            </div>
            <div style="display: flex; align-items: center; gap: 8px">
              <span style="color: #ef4444">🇹🇷 Türkiye:</span>
              <span>${(data.turkey_original || 0).toLocaleString()} ${data.turkey_unit}</span>
            </div>
          </div>
        `
      }
              ...
              {filteredData.map((item, index) => (
                <tr key={index} className="border-t border-gray-700 hover:bg-gray-750">
                  ...
                  <td className="p-4 text-center">
                    <div className="space-y-1">
                      <div className="text-white font-semibold">
                        {(item.us_value || 0).toLocaleString()} {item.us_unit}
                      </div>
                  ...
                  <td className="p-4 text-center">
                    <div className="space-y-1">
                      <div className="text-white font-semibold">
                        {(item.turkey_value || 0).toLocaleString()} {item.turkey_unit}
                      </div>
                      <div className="flex items-center justify-center gap-1">
