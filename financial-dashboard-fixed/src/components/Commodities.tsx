            ...
            <div className="flex items-center justify-between">
              ...
              <div className="text-right">
                <p className="text-2xl font-bold text-white">
                  {commodity.price.toLocaleString('tr-TR', { maximumFractionDigits: 2 })}
                </p>
              ...
              <div className="flex items-center space-x-2">
                ...
                {commodity.intradayHigh && (
                  <span className="text-blue-400 text-sm">
                    Günlük Yüksek: {commodity.intradayHigh.toLocaleString('tr-TR')}
                  </span>
                )}
              </div>
            </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-gray-700/20 rounded-lg p-3">
          ...
          <p className="text-green-500 font-bold">
            {data.commodities.reduce((best, commodity) => 
              commodity.changePercent > best.changePercent ? commodity : best
            ).name} +{data.commodities.reduce((best, commodity) => 
              commodity.changePercent > best.changePercent ? commodity : best
        ...
        <div className="bg-gray-700/20 rounded-lg p-3">
          ...
          <p className="text-red-500 font-bold">
            {data.commodities.reduce((worst, commodity) => 
              commodity.changePercent < worst.changePercent ? commodity : worst
            ).name} {data.commodities.reduce((worst, commodity) => 
              commodity.changePercent < worst.changePercent ? commodity : worst
            ).changePercent.toFixed(1)}%
          </p>
        </div>
