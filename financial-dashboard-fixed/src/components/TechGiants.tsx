      ...
      <div className="mt-4 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-gray-700/20 rounded-lg p-3">
          ...
          <p className="text-green-500 font-bold">
            {data.companies.reduce((best, company) => 
              company.changePercent > best.changePercent ? company : best
            ).symbol} +{data.companies.reduce((best, company) => 
              company.changePercent > best.changePercent ? company : best
        ...
        <div className="bg-gray-700/20 rounded-lg p-3">
          ...
          <p className="text-red-500 font-bold">
            {data.companies.reduce((worst, company) => 
              company.changePercent < worst.changePercent ? company : worst
            ).symbol} {data.companies.reduce((worst, company) => 
              company.changePercent < worst.changePercent ? company : worst
            ).changePercent.toFixed(2)}%
          </p>
        </div>
        ...
        <div className="bg-gray-700/20 rounded-lg p-3">
          ...
          <p className="text-white font-bold">
            {(data.companies.reduce((sum, company) => sum + company.changePercent, 0) / data.companies.length).toFixed(2)}%
          </p>
        </div>
      </div>
    </div>
